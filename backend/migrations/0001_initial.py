    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_refresh', models.DateTimeField(null=True)),
                ('clan', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='backend.Clan')),
            ],
        ),
        migrations.CreateModel(
            name='ClanWar',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('card', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='player', to='backend.Card')),
                ('player', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='card_level', to='backend.Player')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('clan', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='backend.Clan')),
                ('player', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='backend.Player')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('clan_war', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='backend.ClanWar')),
        ...
        migrations.AddField(
            model_name='battle',
            name='mode',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='mode', to='backend.BattleMode'),
        ),
        migrations.AddField(
            model_name='battle',
            name='opponent',
            field=models.ManyToManyField(related_name='opponent', to='backend.Player'),
        ),
        migrations.AddField(
            model_name='battle',
            name='opponent_deck',
            field=models.ManyToManyField(related_name='opponent_1_deck', to='backend.Card'),
        ),
        migrations.AddField(
            model_name='battle',
            name='opponent_team_deck',
            field=models.ManyToManyField(related_name='opponent_2_deck', to='backend.Card'),
        ),
        migrations.AddField(
            model_name='battle',
            name='player_deck',
            field=models.ManyToManyField(related_name='team_1_deck', to='backend.Card'),
        ),
        migrations.AddField(
            model_name='battle',
            name='team',
            field=models.ManyToManyField(related_name='team', to='backend.Player'),
        ),
        migrations.AddField(
            model_name='battle',
            name='team_deck',
            field=models.ManyToManyField(related_name='team_2_deck', to='backend.Card'),
        ),
        migrations.AddField(
            model_name='battle',
            name='war',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='backend.ClanWar'),
        ),
    ]
